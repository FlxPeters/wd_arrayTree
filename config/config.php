...
$GLOBALS['BE_FFL']['arrayTree'] = 'ArrayTree';

if (TL_MODE == 'BE')
{
	$GLOBALS['TL_JAVASCRIPT'][] = 'system/modules/wd_ArrayTree/html/js/arrayTree_src.js'; 
}


$GLOBALS['TL_HOOKS']['executePreActions'][] = array('ArrayTree', 'executePreActions');
